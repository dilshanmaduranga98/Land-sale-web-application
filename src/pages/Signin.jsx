...
export default function Signin() {
  ...
  return (
    <section className="relative w-full overflow-hidden h-[90vh] bg-gradient-to-l from-black to-white-0">
      ...
      <h1 
      className="mt-6 text-[2.5em] font-bold text-center flex justify-end mr-[22%] items-center text-white">Sign In</h1>
      ...
      className="flex flex-wrap items-center justify-center max-w-6xl px-6 py-6 mx-auto">
        ...
        <div className="w-full md:w=[67%] lg:w-[40%] lg:ml-20">
          ...
          <button type='submit' className='w-full py-1.5 text-white bg-blue-600 px-7 rounded hover:bg-blue-800 transition duration-200'>Sign in
          </button>
